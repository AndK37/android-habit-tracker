...
public class DayHabit extends Habit {
    private int counter;
    public DayHabit(Context context, SQLiteDatabase db, int id) {
        super(context, db, id);
        this.counter = this.checkDates.length;
        initHabit();
    }
    ...
    public void initHabit() {
        ...
        View hContainer = layoutInflater.inflate(R.layout.day_habit, container, false);
        ...
        TextView counter = habitContainer.findViewById(R.id.counterTV);
        counter.setText(context.getString(R.string.day_counter, this.counter));
